...
```text
/demo/base?lineup=violin,viola,cello,double-bass
```
...
- 单人独奏
  放置 1 位演奏家，进入单人高亮模式。
- 自由组合
  放置 2 位及以上但不满足固定编制规则时，进入创意探索模式。
- 提琴家族四件套
  小提琴、中提琴、大提琴、低音提琴全部在场时解锁。
- 木管五重奏
  长笛、单簧管、双簧管、巴松、圆号全部在场时解锁。
- 全员合奏
  集齐 12 位演奏家时解锁。
...
- 已有
  相机背景、虚拟舞台、12 位占位乐手、曲目切换、场景切换、数字名片、百科占位和 NFC mock 适配器。
- 暂未接入
  真实 NFC 读卡、真实视觉锚定、真实 3D 乐手模型、正式曲库和正式百科内容。
