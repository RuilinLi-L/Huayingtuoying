      ...
      <section className="home-hero" id="overview">
        <div className="home-hero__content">
          ...
          <p className="home-hero__summary">
            当前版本已接入《睡美人圆舞曲》12 条分轨，完整验证“落子识别 →
            扫码进入 → 乐团生成 → 分轨联动 → 乐手科普”的核心链路，并预留 NFC 接口。
          </p>
        ...
        <div className="home-hero__stack">
          ...
          <article className="card home-highlight">
            ...
            <p>先用浏览器完成体验闭环，当前已接入《睡美人圆舞曲》分轨，后续再替换成真实 3D 角色和 NFC 硬件联动。</p>
          </article>
        </div>
      </section>
      ...
      <section className="card delivery-panel" id="demo">
        <div className="section-heading">
          <div>
            ...
            <h2>这版已接入《睡美人圆舞曲》分轨，再继续替换真实素材</h2>
          </div>
          <Link className="button" to="/demo/base">
            直接体验 demo
          </Link>
        ...
        <ul className="feature-list">
          <li>《睡美人圆舞曲》12 轨分轨、12 位演奏家组合规则、场景切换和全局时间轴同步。</li>
          <li>模拟 NFC 适配器与预留硬件接口，后续只需要替换数据源。</li>
          <li>相机背景 + 虚拟乐团舞台，先验证 Web 端合奏与分轨体验结构。</li>
