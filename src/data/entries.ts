    ...
    knowledgeCards: [
      {
        ...
        title: '长笛怎样表现节奏里的气口',
        summary:
          '长笛适合说明“节奏不只是数拍”。同样是一拍，吹成长音、短音、连音或带休止的气口，听感会完全不同。看这张卡时，可以把注意力放在时值、停顿和换气怎样连成一句乐句。',
      },
      {
        id: 'flute-register',
        anchor: '高音区',
  ...
  },
  {
    ...
    knowledgeCards: [
      ...
      },
      {
        ...
        title: '通过静音听懂节拍和节奏层',
        summary:
          '合奏里的节奏通常分层工作：有的声部稳定拍点，有的声部填充短音，有的声部用附点、切分或休止制造变化。通过静音和独奏，用户可以把“节拍骨架”和“节奏装饰”分开听。',
      },
      {
        id: 'ensemble-rollout',
        anchor: '试点场景',
