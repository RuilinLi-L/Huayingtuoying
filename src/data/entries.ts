    ...
    knowledgeCards: [
      {
        ...
        title: '长笛如何把节奏吹出呼吸感',
        summary:
          '长笛的节奏不只是把拍子吹准，还包括短音、长音、停顿和换气怎样连成一句话。听《睡美人圆舞曲》时，可以先跟住 3/4 拍的“强、弱、弱”，再感受气口如何让舞步变轻。',
      },
      {
        id: 'flute-register',
        anchor: '高音区',
  ...
  },
  {
    ...
    knowledgeCards: [
      ...
      },
      {
        ...
        title: '通过静音听懂节拍和配器关系',
        summary:
          '《睡美人圆舞曲》的 3/4 拍会反复形成“强、弱、弱”的重心循环。用户关闭或独奏某一条声部时，能听见哪些乐器在稳住拍点，哪些乐器在上方用短音、附点和停顿装饰节奏。',
      },
      {
        id: 'ensemble-rollout',
        anchor: '试点场景',
